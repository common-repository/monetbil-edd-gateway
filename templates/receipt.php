...
<html>
    <head>
        ...
        <meta name="author" content="Monetbil.com">

        <title><?php echo get_bloginfo('name') . ' | ' . __('Monetbil Payment', Monetbil_Edd_Gateway::GATEWAY); ?></title>
        ...
        foreach ($linesh as $value) {
            ...
            if (false !== stripos($value, '/plugins/monetbil-edd-gateway/assets/css')) {
                echo $value;
            }
        }
        ?>
    ...
    <body>
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <div class="panel">
                    <div class="panel-heading">
                        <h1 class="panel-title text-dark"><?php echo get_bloginfo('name'); ?></h1>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <?php
                            /**
                             * easy-digital-downloads/templates/shortcode-receipt.php
                             * 
                            ...
                            <table id="edd_purchase_receipt" class="table table-bordered table-hover">
                                <thead>
                            ...
                            <?php if (filter_var($edd_receipt_args['products'], FILTER_VALIDATE_BOOLEAN)) : ?>
                                ...
                                <h3 class="m-t-20"><?php echo apply_filters('edd_payment_receipt_products_title', __('Products', 'easy-digital-downloads')); ?></h3>

                                <table id="edd_purchase_receipt_products" class="table table-bordered table-hover">
                                    <thead>
                        ...
                        <?php if (Monetbil_Edd_Gateway::WIDGET_VERSION_V2 == Monetbil_Edd_Gateway::getWidgetVersion()): ?>
                            <?php include 'payment-widget-v2.php'; ?>
                        <?php else: ?>
                            <?php include 'payment-widget-v1.php'; ?>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        foreach ($linesf as $value) {
            ...
            if (false !== stripos($value, '/plugins/monetbil-edd-gateway/assets/js')) {
                echo $value;
            }
        }
        ?>
